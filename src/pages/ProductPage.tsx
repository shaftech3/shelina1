    ...
    ? [
        {
          ...
          offers: {
            '@type': 'Offer',
            url: `https://shelina1.vercel.app/product/${product.slug}`,
            priceCurrency: 'PKR',
            price: payable,
          ...
          itemListElement: [
            {
              ...
              position: 1,
              name: 'Home',
              item: 'https://shelina1.vercel.app/',
            },
            {
              '@type': 'ListItem',
              position: 2,
              name: 'Shop',
              item: 'https://shelina1.vercel.app/shop',
            },
            {
              '@type': 'ListItem',
              position: 3,
              name: product.name,
              item: `https://shelina1.vercel.app/product/${product.slug}`,
            },
          ],
        },
      ]
